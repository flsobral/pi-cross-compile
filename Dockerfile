...
RUN cd skia && bin/gn gen out/arm64  --args='target_cpu="arm" is_component_build=true is_official_build=true skia_use_expat=false skia_use_libjpeg_turbo=false skia_use_libpng=true skia_use_libwebp=false skia_use_zlib=false' 
